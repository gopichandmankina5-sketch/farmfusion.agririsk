export const getVoiceResponse = (intent, lang, data = {}) => {
  ...
  const responses = {
    en: {
      ...
      NAVIGATE_DECISION_SIMULATOR: 'Opening the Decision Simulator.',
      ...
      FORM_STATE_SELECTED: `State selected: ${data.value}.`,
      FORM_DISTRICT_SELECTED: `District selected: ${data.value}.`,
      FORM_CROP_SELECTED: `Crop selected: ${data.value}.`,
      FORM_SEASON_SELECTED: `Season selected: ${data.value}.`,
      FORM_ALL_SELECTED: 'All analysis parameters have been selected.',
      FORM_DISTRICT_UNAVAILABLE: `${data.district} is not available for the selected state.`,
      FORM_MISSING_FIELDS: `Please select the ${data.missing} first.`,
      FORM_NOT_ON_PAGE: 'Please open Risk Analysis first.',
    ...
    te: {
      ...
      NAVIGATE_DECISION_SIMULATOR: 'డెసిషన్ సిమ్యులేటర్ను తెరుస్తున్నాను.',
      ...
      FORM_STATE_SELECTED: `రాష్ట్రం ${data.value}గా ఎంచుకోబడింది.`,
      FORM_DISTRICT_SELECTED: `జిల్లా ${data.value}గా ఎంచుకోబడింది.`,
      FORM_CROP_SELECTED: `పంటగా ${data.value} ఎంచుకోబడింది.`,
      FORM_SEASON_SELECTED: `${data.value} సీజన్ ఎంచుకోబడింది.`,
      FORM_ALL_SELECTED: 'అన్ని విశ్లేషణ పారామితులు ఎంచుకోబడ్డాయి.',
      FORM_DISTRICT_UNAVAILABLE: `ఎంచుకున్న రాష్ట్రానికి ${data.district} అందుబాటులో లేదు.`,
      FORM_MISSING_FIELDS: `దయచేసి ముందుగా ${data.missing} ఎంచుకోండి.`,
      FORM_NOT_ON_PAGE: 'దయచేసి ముందుగా రిస్క్ అనాలిసిస్ తెరవండి.',
    ...
    ta: {
      ...
      NAVIGATE_DECISION_SIMULATOR: 'டிசிஷன் சிமுலேட்டரைத் திறக்கிறேன்.',
      ...
      FORM_STATE_SELECTED: `${data.value} மாநிலமாக தேர்வு செய்யப்பட்டது.`,
      FORM_DISTRICT_SELECTED: `${data.value} மாவட்டம் தேர்வு செய்யப்பட்டது.`,
      FORM_CROP_SELECTED: `${data.value} பயிர் தேர்வு செய்யப்பட்டது.`,
      FORM_SEASON_SELECTED: `${data.value} பருவம் தேர்வு செய்யப்பட்டது.`,
      FORM_ALL_SELECTED: 'அனைத்து பகுப்பாய்வு அளவுருக்களும் தேர்ந்தெடுக்கப்பட்டுள்ளன.',
      FORM_DISTRICT_UNAVAILABLE: `தேர்ந்தெடுக்கப்பட்ட மாநிலத்திற்கு ${data.district} கிடைக்கவில்லை.`,
      FORM_MISSING_FIELDS: `முதலில் ${data.missing} தேர்வு செய்யவும்.`,
      FORM_NOT_ON_PAGE: 'தயவுசெய்து முதலில் ஆபத்து பகுப்பாய்வு பக்கத்தை திறக்கவும்.',
    ...
    hi: {
      ...
      NAVIGATE_DECISION_SIMULATOR: 'डिसीजन सिम्युलेटर खोल रहा हूँ।',
      ...
      FORM_STATE_SELECTED: `राज्य ${data.value} चुना गया है।`,
      FORM_DISTRICT_SELECTED: `जिला ${data.value} चुना गया है।`,
      FORM_CROP_SELECTED: `फसल ${data.value} चुनी गई है।`,
      FORM_SEASON_SELECTED: `${data.value} मौसम चुना गया है।`,
      FORM_ALL_SELECTED: 'सभी विश्लेषण पैरामीटर चुने गए हैं।',
      FORM_DISTRICT_UNAVAILABLE: `चयनित राज्य के लिए ${data.district} उपलब्ध नहीं है।`,
      FORM_MISSING_FIELDS: `कृपया पहले ${data.missing} चुनें।`,
      FORM_NOT_ON_PAGE: 'कृपया पहले जोखिम विश्लेषण पृष्ठ खोलें।',
